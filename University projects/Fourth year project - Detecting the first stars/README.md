### For my fouth year project, I had to create a simulation using Fast21cm of the universe and then analyse that data from the recovery process with the simulation.
